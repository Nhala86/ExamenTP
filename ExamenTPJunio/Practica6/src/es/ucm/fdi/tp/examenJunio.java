...
import es.ucm.fdi.tp.practica5.foxy.FoxyFactoryExt;
...
// -------------------------------------------HELP OPTION-----------------------------------------------//
	...
	private static void parseHelpOption(CommandLine line, Options cmdLineOptions) {
		if (line.hasOption("h")) {
			...
			formatter.printHelp(examenJunio.class.getCanonicalName(), cmdLineOptions, true);
			System.exit(0);
		}
	}
...
// -------------------------------------------GAME OPTION-----------------------------------------------//
	...
	private static void parseGameOption(CommandLine line) throws ParseException {
		...
		case Foxy:
			if(dimRows != null && dimCols != null && dimRows == dimCols){
				gameFactory = new FoxyFactoryExt(dimRows);
			}
			else{
